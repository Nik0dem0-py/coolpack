...
```
      --cache string              The directory where packwiz will cache downloaded mods (default "C:\\Users\\ntroj\\AppData\\Local\\packwiz\\cache")
      --config string             The config file to use (default "C:\Users\ntroj\AppData\Roaming\packwiz\.packwiz.toml")
